...
from reportlab.lib.testutils import setOutDir, outputfile, printLocation
setOutDir(__name__)
import os,unittest
...
GRID_STYLE = TableStyle(
    ...
    """, styleSheet['Code']))
    lst.append(Paragraph("""
    TableStyles are created by pasting in a list of commands. There are two types of commands - line commands
...
LIST_STYLE = TableStyle(
   ...
   ts = TableStyle(
    ...
    t = Table([[u'Corporate astets','Amount'],
               ['Fixed astets','1,234,567.89'],
...
#s="$insertImage #path BAC-07-Estructura_del_negocio_EPS.png #width 5"
 
#match = re.search(r"\$insert(?P<type>Image) #path (?P<path>([a-zA-Z]|[0-9]|-|_| |\.)+) #width (?P<width>([0-9]+))", s)
 
#print('Width:', int(match.group('width')))
#print('Row range:', match.group('rowRange'))
